...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.wiki.pane.noDirectory': '저장소 Wiki를 읽으려면 프로젝트를 선택하세요.',
  ...
  // Repo Wiki
  'contextRail.surface.repoWiki.description': '이 저장소를 위한 AI 생성 아키텍처 가이드',
  'contextRail.surface.repoWiki': '저장소 Wiki',
  'contextPanel.mode.repoWiki': '저장소 Wiki',
  'repoWiki.empty.title': '아직 저장소 Wiki가 없습니다',
  'repoWiki.empty.description': '이 저장소의 아키텍처 가이드를 생성합니다. 코드를 읽고 그 동작 방식을 설명하는 페이지 목록을 만듭니다.',
  'repoWiki.empty.readOnlyDescription': '저장소 Wiki는 웹 또는 데스크톱에서 생성됩니다. 이 탭은 읽기 전용입니다.',
  'repoWiki.options.language': '언어',
  'repoWiki.options.diagrams': '다이어그램 생성',
  'repoWiki.options.diagrams.hint': '실제로 이해에 도움이 되는 곳에 Mermaid 다이어그램을 추가합니다',
  'repoWiki.options.model': '모델',
  'repoWiki.options.model.default': '기본 모델',
  'repoWiki.options.retries': '페이지당 재시도 횟수',
  'repoWiki.options.retries.none': '재시도 안 함',
  'repoWiki.options.retries.hint': '실패한 페이지 호출은 이 횟수만큼 다시 시도됩니다. 시도 한 번에 최대 3분이 걸릴 수 있습니다.',
  'repoWiki.options.thoughtLevel': '사고 수준',
  'repoWiki.options.thoughtLevel.default': '모델 기본값',
  'repoWiki.options.thoughtLevel.off': '끄기',
  'repoWiki.options.thoughtLevel.low': '낮음',
  'repoWiki.options.thoughtLevel.medium': '중간',
  'repoWiki.options.thoughtLevel.high': '높음',
  'repoWiki.options.thoughtLevel.hint': '작성 중에 모델에게 더 깊은 추론을 요청합니다. 선택한 모델이 이행할 수 없는 수준은 거부됩니다.',
  'repoWiki.generate.action': '생성',
  'repoWiki.generate.running': '생성 중…',
  'repoWiki.generate.stop': '중지',
  'repoWiki.progress.stage.digesting': '저장소 읽는 중',
  'repoWiki.progress.stage.catalog': '목차 설계 중',
  'repoWiki.progress.stage.pages': '페이지 작성 중',
  'repoWiki.page.status.pending': '대기 중',
  'repoWiki.page.status.writing': '작성 중',
  'repoWiki.page.status.done': '완료',
  'repoWiki.page.status.failed': '실패',
  'repoWiki.page.retry': '다시 시도',
  'repoWiki.pages.failedCount': '{count}개 실패',
  'repoWiki.pages.retryFailed': '실패한 페이지 다시 시도',
  'repoWiki.meta.details': 'Wiki 세부 정보',
  'repoWiki.meta.pages': '페이지',
  'repoWiki.meta.model': '모델',
  'repoWiki.meta.thoughtLevel': '사고 수준',
  'repoWiki.meta.stage': '단계',
  'repoWiki.switcher.label': 'Wiki 프로젝트 전환',
  'repoWiki.switcher.error': '프로젝트 목록을 불러오지 못했습니다',
  'repoWiki.switcher.empty': '다른 저장된 Wiki가 없습니다',
  'repoWiki.stale.banner': '이 Wiki를 생성한 이후 코드가 변경되었습니다.',
  'repoWiki.stale.regenerate': '다시 생성',
  'repoWiki.delete.action': 'Wiki 삭제',
  'repoWiki.delete.confirmTitle': '이 저장소 Wiki를 삭제할까요?',
  'repoWiki.delete.confirmDescription': '생성된 페이지는 OpenChamber 저장소에서 삭제됩니다. 여러분의 저장소는 건드리지 않습니다.',
  'repoWiki.delete.confirm': '삭제',
  'repoWiki.delete.cancel': '취소',
  'repoWiki.error.generic': '저장소 Wiki를 사용할 수 없습니다',
  'repoWiki.error.runInProgress': '이 프로젝트의 저장소 Wiki가 이미 생성 중입니다. 완료될 때까지 기다려 주세요',
  'repoWiki.error.noModel': '이 Wiki에 사용할 수 있는 모델이 없습니다. 옵션에서 모델을 선택한 뒤 다시 시도해 주세요',
  'repoWiki.error.noProviderLogin': '이 모델의 공급자 로그인을 찾을 수 없습니다. 공급자에 로그인하거나 다른 모델을 선택해 주세요',
  'repoWiki.error.contextTooSmall': '저장소 요약이 이 모델의 컨텍스트 한도를 초과합니다. 약 {required}자가 필요하며 {available}자까지 사용할 수 있습니다',
  'repoWiki.error.noWiki': '이 프로젝트에는 아직 저장소 Wiki가 없습니다',
  'repoWiki.error.unknownPage': '해당 Wiki 페이지는 더 이상 존재하지 않습니다',
  'repoWiki.error.pageNotFailed': '실패한 페이지만 다시 시도할 수 있습니다. 대신 Wiki를 다시 생성해 주세요',
  'repoWiki.error.malformedResponse': '저장소 Wiki 응답 형식이 잘못되었습니다',
  'repoWiki.error.interrupted': '서버 재시작으로 생성이 중단되었습니다. 페이지를 다시 시도하여 완료하세요',
  'repoWiki.error.invalidRetries': '재시도 횟수는 0에서 3 사이의 숫자여야 합니다',
  'repoWiki.error.truncated': '페이지가 모델 출력 한도에 도달해 잘렸습니다. 페이지를 다시 시도하세요',
  'repoWiki.error.thoughtLevelUnsupported': '선택한 모델은 이 사고 수준을 지원하지 않습니다. 다른 수준 또는 모델을 선택하세요',
  'repoWiki.error.readStatus': '저장소 Wiki 상태를 읽지 못했습니다',
  'repoWiki.error.readPage': '저장소 Wiki 페이지를 읽지 못했습니다',
  'repoWiki.error.startGeneration': '저장소 Wiki 생성을 시작하지 못했습니다',
  'repoWiki.error.stopGeneration': '저장소 Wiki 생성을 중지하지 못했습니다',
  'repoWiki.error.retryPage': '저장소 Wiki 페이지 재시도에 실패했습니다',
  'repoWiki.error.deleteWiki': '저장소 Wiki 삭제에 실패했습니다',
};
