...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.wiki.pane.noDirectory': '选择一个项目以阅读它的仓库 Wiki。',
  ...
  // Repo Wiki
  'contextRail.surface.repoWiki.description': '为本仓库生成的 AI 架构指南',
  'contextRail.surface.repoWiki': '仓库 Wiki',
  'contextPanel.mode.repoWiki': '仓库 Wiki',
  'repoWiki.empty.title': '还没有仓库 Wiki',
  'repoWiki.empty.description': '为本仓库生成一份架构指南：通过阅读代码，生成一系列页面，讲解这套代码是如何工作的。',
  'repoWiki.empty.readOnlyDescription': '本仓库的仓库 Wiki 通过 Web 或桌面端生成，此标签页仅用于阅读。',
  'repoWiki.options.language': '语言',
  'repoWiki.options.diagrams': '生成示意图',
  'repoWiki.options.diagrams.hint': '在真正有助于理解的地方添加 Mermaid 示意图',
  'repoWiki.options.model': '模型',
  'repoWiki.options.model.default': '默认模型',
  'repoWiki.options.retries': '每页重试次数',
  'repoWiki.options.retries.none': '不重试',
  'repoWiki.options.retries.hint': '页面调用失败后最多重试此次数。单次尝试最长可能需要 3 分钟。',
  'repoWiki.options.thoughtLevel': '思考档位',
  'repoWiki.options.thoughtLevel.default': '模型默认',
  'repoWiki.options.thoughtLevel.off': '关闭',
  'repoWiki.options.thoughtLevel.low': '低',
  'repoWiki.options.thoughtLevel.medium': '中',
  'repoWiki.options.thoughtLevel.high': '高',
  'repoWiki.options.thoughtLevel.hint': '让模型在撰写时进行更深入的推理。所选模型无法满足的档位会被拒绝。',
  'repoWiki.generate.action': '生成',
  'repoWiki.generate.running': '正在生成…',
  'repoWiki.generate.stop': '停止',
  'repoWiki.progress.stage.digesting': '正在阅读仓库',
  'repoWiki.progress.stage.catalog': '正在设计目录',
  'repoWiki.progress.stage.pages': '正在撰写页面',
  'repoWiki.page.status.pending': '等待中',
  'repoWiki.page.status.writing': '撰写中',
  'repoWiki.page.status.done': '已完成',
  'repoWiki.page.status.failed': '失败',
  'repoWiki.page.retry': '重试',
  'repoWiki.pages.failedCount': '{count} 页失败',
  'repoWiki.pages.retryFailed': '重试失败页',
  'repoWiki.meta.details': 'Wiki 详情',
  'repoWiki.meta.pages': '页数',
  'repoWiki.meta.model': '模型',
  'repoWiki.meta.thoughtLevel': '思考档位',
  'repoWiki.meta.stage': '阶段',
  'repoWiki.switcher.label': '切换 Wiki 项目',
  'repoWiki.switcher.error': '无法加载项目列表',
  'repoWiki.switcher.empty': '没有其他已存储的 Wiki',
  'repoWiki.stale.banner': '此 Wiki 生成之后，代码已经发生变化。',
  'repoWiki.stale.regenerate': '重新生成',
  'repoWiki.delete.action': '删除 Wiki',
  'repoWiki.delete.confirmTitle': '删除这个仓库 Wiki？',
  'repoWiki.delete.confirmDescription': '生成的页面将从 OpenChamber 存储中删除，你的仓库不会受到任何改动。',
  'repoWiki.delete.confirm': '删除',
  'repoWiki.delete.cancel': '取消',
  'repoWiki.error.generic': '仓库 Wiki 不可用',
  'repoWiki.error.runInProgress': '该项目已在生成仓库 Wiki，请等待完成',
  'repoWiki.error.noModel': '没有可用于此 Wiki 的模型，请在选项中选择模型后重试',
  'repoWiki.error.noProviderLogin': '未找到此模型的提供商登录凭据，请登录该提供商或改用其他模型',
  'repoWiki.error.contextTooSmall': '仓库摘要超出该模型的上下文限制：约需 {required} 个字符，当前仅可容纳 {available} 个',
  'repoWiki.error.noWiki': '该项目还没有仓库 Wiki',
  'repoWiki.error.unknownPage': '该 Wiki 页面已不存在',
  'repoWiki.error.pageNotFailed': '只有失败的页面可以重试，请改为重新生成整个 Wiki',
  'repoWiki.error.malformedResponse': '仓库 Wiki 的响应格式不正确',
  'repoWiki.error.interrupted': '生成因服务器重启而中断。请重试该页以完成',
  'repoWiki.error.invalidRetries': '重试次数必须是 0 到 3 之间的整数',
  'repoWiki.error.truncated': '页面超出模型输出上限被截断。请重试该页',
  'repoWiki.error.thoughtLevelUnsupported': '所选模型不支持该思考档位。请换一个档位或模型',
  'repoWiki.error.readStatus': '读取仓库 Wiki 状态失败',
  'repoWiki.error.readPage': '读取仓库 Wiki 页面失败',
  'repoWiki.error.startGeneration': '启动仓库 Wiki 生成失败',
  'repoWiki.error.stopGeneration': '停止仓库 Wiki 生成失败',
  'repoWiki.error.retryPage': '重试仓库 Wiki 页面失败',
  'repoWiki.error.deleteWiki': '删除仓库 Wiki 失败',
};
