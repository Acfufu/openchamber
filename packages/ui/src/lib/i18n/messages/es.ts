...
export const dict: Record<I18nKey, string> = {
  ...
  "mobile.wiki.pane.noDirectory": "Selecciona un proyecto para leer su wiki del repo.",
  ...
  // Repo Wiki
  'contextRail.surface.repoWiki.description': 'Guía de arquitectura generada por IA para este repositorio',
  'contextRail.surface.repoWiki': 'Wiki del repo',
  'contextPanel.mode.repoWiki': 'Wiki del repo',
  'repoWiki.empty.title': 'Aún no hay wiki del repo',
  'repoWiki.empty.description': 'Genera una guía de arquitectura de este repositorio: un catálogo de páginas que explican cómo funciona el código, escrito leyendo el código.',
  'repoWiki.empty.readOnlyDescription': 'La wiki del repo de este repositorio se genera en la versión web o de escritorio. Esta pestaña es solo de lectura.',
  'repoWiki.options.language': 'Idioma',
  'repoWiki.options.diagrams': 'Generar diagramas',
  'repoWiki.options.diagrams.hint': 'Añade diagramas de Mermaid donde ayudan de verdad',
  'repoWiki.options.model': 'Modelo',
  'repoWiki.options.model.default': 'Modelo predeterminado',
  'repoWiki.options.retries': 'Reintentos por página',
  'repoWiki.options.retries.none': 'Sin reintentos',
  'repoWiki.options.retries.hint': 'Una llamada de página fallida se reintenta hasta este número de veces. Un intento puede tardar hasta 3 minutos.',
  'repoWiki.options.thoughtLevel': 'Nivel de razonamiento',
  'repoWiki.options.thoughtLevel.default': 'Predeterminado del modelo',
  'repoWiki.options.thoughtLevel.off': 'Apagado',
  'repoWiki.options.thoughtLevel.low': 'Bajo',
  'repoWiki.options.thoughtLevel.medium': 'Medio',
  'repoWiki.options.thoughtLevel.high': 'Alto',
  'repoWiki.options.thoughtLevel.hint': 'Pide al modelo un razonamiento más profundo mientras escribe. Un nivel que el modelo elegido no pueda cumplir se rechaza.',
  'repoWiki.generate.action': 'Generar',
  'repoWiki.generate.running': 'Generando…',
  'repoWiki.generate.stop': 'Detener',
  'repoWiki.progress.stage.digesting': 'Leyendo el repositorio',
  'repoWiki.progress.stage.catalog': 'Diseñando el catálogo',
  'repoWiki.progress.stage.pages': 'Escribiendo las páginas',
  'repoWiki.page.status.pending': 'En espera',
  'repoWiki.page.status.writing': 'Escribiendo',
  'repoWiki.page.status.done': 'Hecho',
  'repoWiki.page.status.failed': 'Fallido',
  'repoWiki.page.retry': 'Reintentar',
  'repoWiki.pages.failedCount': '{count} con error',
  'repoWiki.pages.retryFailed': 'Reintentar las páginas con fallo',
  'repoWiki.meta.details': 'Detalles del wiki',
  'repoWiki.meta.pages': 'Páginas',
  'repoWiki.meta.model': 'Modelo',
  'repoWiki.meta.thoughtLevel': 'Nivel de razonamiento',
  'repoWiki.meta.stage': 'Etapa',
  'repoWiki.switcher.label': 'Cambiar de proyecto del wiki',
  'repoWiki.switcher.error': 'No se pudo cargar la lista de proyectos',
  'repoWiki.switcher.empty': 'No hay otros wikis guardados',
  'repoWiki.stale.banner': 'El código cambió desde que se generó esta wiki.',
  'repoWiki.stale.regenerate': 'Regenerar',
  'repoWiki.delete.action': 'Eliminar wiki',
  'repoWiki.delete.confirmTitle': '¿Eliminar esta wiki del repo?',
  'repoWiki.delete.confirmDescription': 'Las páginas generadas se borran del almacenamiento de OpenChamber. Tu repositorio no se toca.',
  'repoWiki.delete.confirm': 'Eliminar',
  'repoWiki.delete.cancel': 'Cancelar',
  'repoWiki.error.generic': 'La wiki del repo no está disponible',
  'repoWiki.error.runInProgress': 'Ya se está generando la wiki del repo para este proyecto',
  'repoWiki.error.noModel': 'No hay ningún modelo disponible para esta wiki. Elige un modelo en las opciones e inténtalo de nuevo',
  'repoWiki.error.noProviderLogin': 'No se ha encontrado inicio de sesión del proveedor para este modelo. Inicia sesión en el proveedor o elige otro modelo',
  'repoWiki.error.contextTooSmall': 'El resumen del repositorio supera el límite de contexto de este modelo: se necesitan unos {required} caracteres y hay {available} disponibles',
  'repoWiki.error.noWiki': 'Este proyecto aún no tiene wiki del repo',
  'repoWiki.error.unknownPage': 'Esa página de la wiki ya no existe',
  'repoWiki.error.pageNotFailed': 'Solo se puede reintentar una página fallida. Mejor regenera la wiki',
  'repoWiki.error.malformedResponse': 'La respuesta de la wiki del repo tenía un formato incorrecto',
  'repoWiki.error.interrupted': 'La generación fue interrumpida por un reinicio del servidor. Reintenta la página para terminarla',
  'repoWiki.error.invalidRetries': 'Los reintentos deben ser un número entre 0 y 3',
  'repoWiki.error.truncated': 'La página superó el límite de salida del modelo y quedó cortada. Reintenta la página',
  'repoWiki.error.thoughtLevelUnsupported': 'El modelo elegido no admite este nivel de razonamiento. Elige otro nivel o modelo',
  'repoWiki.error.readStatus': 'No se pudo leer el estado de la wiki del repo',
  'repoWiki.error.readPage': 'No se pudo leer la página de la wiki del repo',
  'repoWiki.error.startGeneration': 'No se pudo iniciar la generación de la wiki del repo',
  'repoWiki.error.stopGeneration': 'No se pudo detener la generación de la wiki del repo',
  'repoWiki.error.retryPage': 'No se pudo reintentar la página de la wiki del repo',
  'repoWiki.error.deleteWiki': 'No se pudo eliminar la wiki del repo',
};
