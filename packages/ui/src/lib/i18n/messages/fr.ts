...
export const dict = {
  ...
  'mobile.wiki.pane.noDirectory': 'Sélectionnez un projet pour lire son Wiki du dépôt.',
  ...
  // Repo Wiki
  'contextRail.surface.repoWiki.description': 'Guide d\'architecture généré par IA pour ce dépôt',
  'contextRail.surface.repoWiki': 'Wiki du dépôt',
  'contextPanel.mode.repoWiki': 'Wiki du dépôt',
  'repoWiki.empty.title': 'Pas encore de wiki du dépôt',
  'repoWiki.empty.description': 'Générez un guide d\'architecture de ce dépôt : un catalogue de pages expliquant le fonctionnement du code, rédigé en lisant le code.',
  'repoWiki.empty.readOnlyDescription': 'Le Wiki du dépôt est généré depuis la version web ou de bureau. Cet onglet est en lecture seule.',
  'repoWiki.options.language': 'Langue',
  'repoWiki.options.diagrams': 'Générer les diagrammes',
  'repoWiki.options.diagrams.hint': 'Ajoute des diagrammes Mermaid là où ils aident vraiment',
  'repoWiki.options.model': 'Modèle',
  'repoWiki.options.model.default': 'Modèle par défaut',
  'repoWiki.options.retries': 'Tentatives par page',
  'repoWiki.options.retries.none': 'Aucune nouvelle tentative',
  'repoWiki.options.retries.hint': 'Un appel de page échoué est relancé jusqu’à ce nombre de fois. Une tentative peut durer jusqu’à 3 minutes.',
  'repoWiki.options.thoughtLevel': 'Niveau de réflexion',
  'repoWiki.options.thoughtLevel.default': 'Valeur par défaut du modèle',
  'repoWiki.options.thoughtLevel.off': 'Désactivé',
  'repoWiki.options.thoughtLevel.low': 'Bas',
  'repoWiki.options.thoughtLevel.medium': 'Moyen',
  'repoWiki.options.thoughtLevel.high': 'Élevé',
  'repoWiki.options.thoughtLevel.hint': 'Demande au modèle un raisonnement plus approfondi pendant la rédaction. Un niveau que le modèle choisi ne peut pas honorer est refusé.',
  'repoWiki.generate.action': 'Générer',
  'repoWiki.generate.running': 'Génération…',
  'repoWiki.generate.stop': 'Arrêter',
  'repoWiki.progress.stage.digesting': 'Lecture du dépôt',
  'repoWiki.progress.stage.catalog': 'Conception du catalogue',
  'repoWiki.progress.stage.pages': 'Rédaction des pages',
  'repoWiki.page.status.pending': 'En attente',
  'repoWiki.page.status.writing': 'Rédaction',
  ...
  'repoWiki.pages.retryFailed': 'Réessayer les pages en échec',
  'repoWiki.meta.details': 'Détails du wiki',
  'repoWiki.meta.pages': 'Pages',
  'repoWiki.meta.model': 'Modèle',
  'repoWiki.meta.thoughtLevel': 'Niveau de réflexion',
  'repoWiki.meta.stage': 'Étape',
  'repoWiki.switcher.label': 'Changer de projet de wiki',
  'repoWiki.switcher.error': 'Impossible de charger la liste des projets',
  'repoWiki.switcher.empty': 'Aucun autre wiki enregistré',
  ...
  'repoWiki.delete.confirmTitle': 'Supprimer ce wiki du dépôt ?',
  'repoWiki.delete.confirmDescription': 'Les pages générées sont supprimées du stockage OpenChamber. Votre dépôt n\'est pas modifié.',
  'repoWiki.delete.confirm': 'Supprimer',
  'repoWiki.delete.cancel': 'Annuler',
  'repoWiki.error.generic': 'Le wiki du dépôt est indisponible',
  'repoWiki.error.runInProgress': 'Une génération de wiki du dépôt est déjà en cours pour ce projet',
  'repoWiki.error.noModel': 'Aucun modèle n\'est disponible pour ce wiki. Choisissez un modèle dans les options et réessayez',
  'repoWiki.error.noProviderLogin': 'Aucune connexion au fournisseur n\'a été trouvée pour ce modèle. Connectez-vous au fournisseur ou choisissez un autre modèle',
  'repoWiki.error.contextTooSmall': 'Le résumé du dépôt dépasse la limite de contexte de ce modèle : environ {required} caractères nécessaires, {available} disponibles',
  'repoWiki.error.noWiki': 'Il n\'y a pas encore de wiki du dépôt pour ce projet',
  'repoWiki.error.unknownPage': 'Cette page du wiki n\'existe plus',
  'repoWiki.error.pageNotFailed': 'Seule une page en échec peut être relancée. Régénérez plutôt le wiki',
  'repoWiki.error.malformedResponse': 'La réponse du wiki du dépôt était mal formée',
  'repoWiki.error.interrupted': 'La génération a été interrompue par un redémarrage du serveur. Relancez la page pour la terminer',
  'repoWiki.error.invalidRetries': 'Le nombre de tentatives doit être un nombre entre 0 et 3',
  'repoWiki.error.truncated': 'La page a dépassé la limite de sortie du modèle et a été tronquée. Réessayez la page',
  'repoWiki.error.thoughtLevelUnsupported': 'Le modèle choisi ne prend pas en charge ce niveau de réflexion. Choisissez un autre niveau ou modèle',
  'repoWiki.error.readStatus': 'Échec de la lecture du statut du wiki du dépôt',
  'repoWiki.error.readPage': 'Échec de la lecture de la page du wiki du dépôt',
  'repoWiki.error.startGeneration': 'Échec du démarrage de la génération du wiki du dépôt',
  'repoWiki.error.stopGeneration': 'Échec de l\'arrêt de la génération du wiki du dépôt',
  'repoWiki.error.retryPage': 'Échec de la relance de la page du wiki du dépôt',
  'repoWiki.error.deleteWiki': 'Échec de la suppression du wiki du dépôt',
} as const;
