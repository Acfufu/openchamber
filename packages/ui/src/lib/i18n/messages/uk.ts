...
export const dict: Record<I18nKey, string> = {
  ...
  "mobile.wiki.pane.noDirectory": "Виберіть проєкт, щоб читати його Вікі репозиторію.",
  ...
  // Repo Wiki
  'contextRail.surface.repoWiki.description': 'Архітектурний довідник для цього репозиторію, згенерований ШІ',
  'contextRail.surface.repoWiki': 'Вікі репозиторію',
  'contextPanel.mode.repoWiki': 'Вікі репозиторію',
  'repoWiki.empty.title': 'Вікі репозиторію ще немає',
  'repoWiki.empty.description': 'Згенеруйте архітектурний довідник цього репозиторію: каталог сторінок, які пояснюють, як працює код, написаний на основі читання коду.',
  'repoWiki.empty.readOnlyDescription': 'Вікі репозиторію генерується у веб- або настільній версії. Ця вкладка призначена лише для читання.',
  'repoWiki.options.language': 'Мова',
  'repoWiki.options.diagrams': 'Створити діаграми',
  'repoWiki.options.diagrams.hint': 'Додає діаграми Mermaid там, де вони справді допомагають',
  'repoWiki.options.model': 'Модель',
  'repoWiki.options.model.default': 'Типова модель',
  'repoWiki.options.retries': 'Повторні спроби на сторінку',
  'repoWiki.options.retries.none': 'Без повторних спроб',
  'repoWiki.options.retries.hint': 'Невдалий виклик сторінки повторюється до цієї кількості разів. Одна спроба може тривати до 3 хвилин.',
  'repoWiki.options.thoughtLevel': 'Рівень мислення',
  'repoWiki.options.thoughtLevel.default': 'Типове для моделі',
  'repoWiki.options.thoughtLevel.off': 'Вимкнено',
  'repoWiki.options.thoughtLevel.low': 'Низький',
  'repoWiki.options.thoughtLevel.medium': 'Середній',
  'repoWiki.options.thoughtLevel.high': 'Високий',
  'repoWiki.options.thoughtLevel.hint': 'Просить модель глибше міркувати під час написання. Рівень, який обрана модель не може забезпечити, буде відхилено.',
  'repoWiki.generate.action': 'Створити',
  'repoWiki.generate.running': 'Створення…',
  'repoWiki.generate.stop': 'Зупинити',
  'repoWiki.progress.stage.digesting': 'Читання репозиторію',
  'repoWiki.progress.stage.catalog': 'Проєктування каталогу',
  'repoWiki.progress.stage.pages': 'Написання сторінок',
  'repoWiki.page.status.pending': 'Очікування',
  'repoWiki.page.status.writing': 'Написання',
  ...
  'repoWiki.pages.retryFailed': 'Повторити невдалі сторінки',
  'repoWiki.meta.details': 'Подробиці wiki',
  'repoWiki.meta.pages': 'Сторінки',
  'repoWiki.meta.model': 'Модель',
  'repoWiki.meta.thoughtLevel': 'Рівень мислення',
  'repoWiki.meta.stage': 'Етап',
  'repoWiki.switcher.label': 'Переключити проєкт wiki',
  'repoWiki.switcher.error': 'Не вдалося завантажити список проєктів',
  'repoWiki.switcher.empty': 'Інших збережених wiki немає',
  ...
  'repoWiki.delete.confirmTitle': 'Видалити цю вікі репозиторію?',
  'repoWiki.delete.confirmDescription': 'Створені сторінки буде видалено зі сховища OpenChamber. Ваш репозиторій не змінюється.',
  'repoWiki.delete.confirm': 'Видалити',
  'repoWiki.delete.cancel': 'Скасувати',
  'repoWiki.error.generic': 'Вікі репозиторію недоступна',
  'repoWiki.error.runInProgress': 'Для цього проєкту вже триває створення вікі репозиторію',
  'repoWiki.error.noModel': 'Для цієї вікі немає доступної моделі. Виберіть модель у параметрах і спробуйте ще раз',
  'repoWiki.error.noProviderLogin': 'Не знайдено входу до провайдера для цієї моделі. Увійдіть до провайдера або виберіть іншу модель',
  'repoWiki.error.contextTooSmall': 'Резюме репозиторію перевищує ліміт контексту цієї моделі: потрібно близько {required} символів, доступно {available}',
  'repoWiki.error.noWiki': 'У цього проєкту ще немає вікі репозиторію',
  'repoWiki.error.unknownPage': 'Цієї сторінки вікі більше не існує',
  'repoWiki.error.pageNotFailed': 'Повторити можна лише невдалу сторінку. Натомість створіть вікі знову',
  'repoWiki.error.malformedResponse': 'Відповідь вікі репозиторію була некоректною',
  'repoWiki.error.interrupted': 'Генерування було перервано через перезапуск сервера. Повторіть сторінку, щоб завершити її',
  'repoWiki.error.invalidRetries': 'Кількість повторних спроб має бути числом від 0 до 3',
  'repoWiki.error.truncated': 'Сторінка перевищила ліміт виводу моделі й була обрізана. Повторіть сторінку',
  'repoWiki.error.thoughtLevelUnsupported': 'Обрана модель не підтримує цей рівень мислення. Виберіть інший рівень або модель',
  'repoWiki.error.readStatus': 'Не вдалося прочитати стан вікі репозиторію',
  'repoWiki.error.readPage': 'Не вдалося прочитати сторінку вікі репозиторію',
  'repoWiki.error.startGeneration': 'Не вдалося почати створення вікі репозиторію',
  'repoWiki.error.stopGeneration': 'Не вдалося зупинити створення вікі репозиторію',
  'repoWiki.error.retryPage': 'Не вдалося повторити сторінку вікі репозиторію',
  'repoWiki.error.deleteWiki': 'Не вдалося видалити вікі репозиторію',
};
