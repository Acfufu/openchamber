...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.wiki.pane.noDirectory': 'リポジトリ Wiki を読むにはプロジェクトを選択します。',
  ...
  // Repo Wiki
  'contextRail.surface.repoWiki.description': 'このリポジトリの AI 生成アーキテクチャガイド',
  'contextRail.surface.repoWiki': 'リポジトリ Wiki',
  'contextPanel.mode.repoWiki': 'リポジトリ Wiki',
  'repoWiki.empty.title': 'リポジトリ Wiki はまだありません',
  'repoWiki.empty.description': 'このリポジトリのアーキテクチャガイドを生成します。コードを読んで、その仕組みを説明するページのカタログを作ります。',
  'repoWiki.empty.readOnlyDescription': 'リポジトリ Wiki は Web またはデスクトップから生成されます。このタブは閲覧専用です。',
  'repoWiki.options.language': '言語',
  'repoWiki.options.diagrams': '図を生成',
  'repoWiki.options.diagrams.hint': '本当に役立つ場所に Mermaid 図を追加します',
  'repoWiki.options.model': 'モデル',
  'repoWiki.options.model.default': 'デフォルトモデル',
  'repoWiki.options.retries': 'ページあたりの再試行回数',
  'repoWiki.options.retries.none': '再試行しない',
  'repoWiki.options.retries.hint': '失敗したページ呼び出しはこの回数まで再試行されます。1 回の試行に最大 3 分かかることがあります。',
  'repoWiki.options.thoughtLevel': '思考レベル',
  'repoWiki.options.thoughtLevel.default': 'モデルのデフォルト',
  'repoWiki.options.thoughtLevel.off': 'オフ',
  'repoWiki.options.thoughtLevel.low': '低',
  'repoWiki.options.thoughtLevel.medium': '中',
  'repoWiki.options.thoughtLevel.high': '高',
  'repoWiki.options.thoughtLevel.hint': '執筆中にモデルへより深い推論を要求します。選択したモデルが対応できないレベルは拒否されます。',
  'repoWiki.generate.action': '生成',
  'repoWiki.generate.running': '生成中…',
  'repoWiki.generate.stop': '停止',
  'repoWiki.progress.stage.digesting': 'リポジトリを読み込み中',
  'repoWiki.progress.stage.catalog': 'カタログを設計中',
  'repoWiki.progress.stage.pages': 'ページを執筆中',
  'repoWiki.page.status.pending': '待機中',
  'repoWiki.page.status.writing': '執筆中',
  'repoWiki.page.status.done': '完了',
  'repoWiki.page.status.failed': '失敗',
  'repoWiki.page.retry': '再試行',
  'repoWiki.pages.failedCount': '{count} 件失敗',
  'repoWiki.pages.retryFailed': '失敗したページを再試行',
  'repoWiki.meta.details': 'Wiki の詳細',
  'repoWiki.meta.pages': 'ページ',
  'repoWiki.meta.model': 'モデル',
  'repoWiki.meta.thoughtLevel': '思考レベル',
  'repoWiki.meta.stage': 'ステージ',
  'repoWiki.switcher.label': 'Wiki のプロジェクトを切り替え',
  'repoWiki.switcher.error': 'プロジェクト一覧を読み込めませんでした',
  'repoWiki.switcher.empty': '他に保存された Wiki はありません',
  'repoWiki.stale.banner': 'この Wiki の生成後にコードが変更されました。',
  'repoWiki.stale.regenerate': '再生成',
  'repoWiki.delete.action': 'Wiki を削除',
  'repoWiki.delete.confirmTitle': 'このリポジトリ Wiki を削除しますか？',
  'repoWiki.delete.confirmDescription': '生成されたページは OpenChamber のストレージから削除されます。リポジトリ自体は変更されません。',
  'repoWiki.delete.confirm': '削除',
  'repoWiki.delete.cancel': 'キャンセル',
  'repoWiki.error.generic': 'リポジトリ Wiki を利用できません',
  'repoWiki.error.runInProgress': 'このプロジェクトのリポジトリ Wiki はすでに生成中です。完了までお待ちください',
  'repoWiki.error.noModel': 'この Wiki に利用できるモデルがありません。オプションでモデルを選択して再試行してください',
  'repoWiki.error.noProviderLogin': 'このモデルのプロバイダーログインが見つかりません。プロバイダーにサインインするか、別のモデルを選んでください',
  'repoWiki.error.contextTooSmall': 'リポジトリのダイジェストがこのモデルのコンテキスト上限を超えています：約 {required} 文字が必要で、利用できるのは {available} 文字です',
  'repoWiki.error.noWiki': 'このプロジェクトにはまだリポジトリ Wiki がありません',
  'repoWiki.error.unknownPage': 'その Wiki ページはもう存在しません',
  'repoWiki.error.pageNotFailed': '再試行できるのは失敗したページだけです。代わりに Wiki を再生成してください',
  'repoWiki.error.malformedResponse': 'リポジトリ Wiki の応答形式が不正です',
  'repoWiki.error.interrupted': 'サーバーの再起動によって生成が中断されました。ページを再試行して完了してください',
  'repoWiki.error.invalidRetries': '再試行回数は 0 から 3 の間の数値で指定してください',
  'repoWiki.error.truncated': 'ページがモデルの出力上限に達し、途中で切られました。ページを再試行してください',
  'repoWiki.error.thoughtLevelUnsupported': '選択したモデルはこの思考レベルに対応していません。別のレベルまたはモデルを選んでください',
  'repoWiki.error.readStatus': 'リポジトリ Wiki の状態の読み取りに失敗しました',
  'repoWiki.error.readPage': 'リポジトリ Wiki のページの読み取りに失敗しました',
  'repoWiki.error.startGeneration': 'リポジトリ Wiki の生成を開始できませんでした',
  'repoWiki.error.stopGeneration': 'リポジトリ Wiki の生成を停止できませんでした',
  'repoWiki.error.retryPage': 'リポジトリ Wiki のページの再試行に失敗しました',
  'repoWiki.error.deleteWiki': 'リポジトリ Wiki の削除に失敗しました',
};
