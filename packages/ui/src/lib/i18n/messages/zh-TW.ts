...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.wiki.pane.noDirectory': '選擇專案以閱讀它的儲存庫 Wiki。',
  ...
  // Repo Wiki
  'contextRail.surface.repoWiki.description': '為本儲存庫產生的 AI 架構指南',
  'contextRail.surface.repoWiki': '儲存庫 Wiki',
  'contextPanel.mode.repoWiki': '儲存庫 Wiki',
  'repoWiki.empty.title': '還沒有儲存庫 Wiki',
  'repoWiki.empty.description': '為本儲存庫產生一份架構指南：透過閱讀程式碼，產生一系列頁面，講解這套程式碼是如何運作的。',
  'repoWiki.empty.readOnlyDescription': '本儲存庫的儲存庫 Wiki 透過 Web 或桌面端產生，此分頁僅供閱讀。',
  'repoWiki.options.language': '語言',
  'repoWiki.options.diagrams': '產生圖表',
  'repoWiki.options.diagrams.hint': '在真正有助於理解的地方加入 Mermaid 圖表',
  'repoWiki.options.model': '模型',
  'repoWiki.options.model.default': '預設模型',
  'repoWiki.options.retries': '每頁重試次數',
  'repoWiki.options.retries.none': '不重試',
  'repoWiki.options.retries.hint': '頁面呼叫失敗後最多重試此次數。單次嘗試最長可能需要 3 分鐘。',
  'repoWiki.options.thoughtLevel': '思考檔位',
  'repoWiki.options.thoughtLevel.default': '模型預設',
  'repoWiki.options.thoughtLevel.off': '關閉',
  'repoWiki.options.thoughtLevel.low': '低',
  'repoWiki.options.thoughtLevel.medium': '中',
  'repoWiki.options.thoughtLevel.high': '高',
  'repoWiki.options.thoughtLevel.hint': '要求模型在撰寫時進行更深入的推理。所選模型無法滿足的檔位會被拒絕。',
  'repoWiki.generate.action': '產生',
  'repoWiki.generate.running': '正在產生…',
  'repoWiki.generate.stop': '停止',
  'repoWiki.progress.stage.digesting': '正在閱讀儲存庫',
  'repoWiki.progress.stage.catalog': '正在設計目錄',
  'repoWiki.progress.stage.pages': '正在撰寫頁面',
  'repoWiki.page.status.pending': '等待中',
  'repoWiki.page.status.writing': '撰寫中',
  'repoWiki.page.status.done': '已完成',
  'repoWiki.page.status.failed': '失敗',
  'repoWiki.page.retry': '重試',
  'repoWiki.pages.failedCount': '{count} 頁失敗',
  'repoWiki.pages.retryFailed': '重試失敗頁面',
  'repoWiki.meta.details': 'Wiki 詳細資訊',
  'repoWiki.meta.pages': '頁數',
  'repoWiki.meta.model': '模型',
  'repoWiki.meta.thoughtLevel': '思考檔位',
  'repoWiki.meta.stage': '階段',
  'repoWiki.switcher.label': '切換 Wiki 專案',
  'repoWiki.switcher.error': '無法載入專案清單',
  'repoWiki.switcher.empty': '沒有其他已儲存的 Wiki',
  'repoWiki.stale.banner': '此 Wiki 產生之後，程式碼已經變更。',
  'repoWiki.stale.regenerate': '重新產生',
  'repoWiki.delete.action': '刪除 Wiki',
  'repoWiki.delete.confirmTitle': '刪除這個儲存庫 Wiki？',
  'repoWiki.delete.confirmDescription': '產生的頁面將從 OpenChamber 儲存空間中刪除，你的儲存庫不會被更動。',
  'repoWiki.delete.confirm': '刪除',
  'repoWiki.delete.cancel': '取消',
  'repoWiki.error.generic': '儲存庫 Wiki 無法使用',
  'repoWiki.error.runInProgress': '此專案已在產生儲存庫 Wiki，請等待完成',
  'repoWiki.error.noModel': '沒有可用於此 Wiki 的模型，請在選項中選擇模型後再試',
  'repoWiki.error.noProviderLogin': '找不到此模型的提供商登入憑證，請登入該提供商或改用其他模型',
  'repoWiki.error.contextTooSmall': '儲存庫摘要超出此模型的上下文限制：約需 {required} 個字元，目前僅可容納 {available} 個',
  'repoWiki.error.noWiki': '此專案還沒有儲存庫 Wiki',
  'repoWiki.error.unknownPage': '該 Wiki 頁面已不存在',
  'repoWiki.error.pageNotFailed': '只有失敗的頁面可以重試，請改為重新產生整個 Wiki',
  'repoWiki.error.malformedResponse': '儲存庫 Wiki 的回應格式不正確',
  'repoWiki.error.interrupted': '產生因伺服器重新啟動而中斷。請重試該頁以完成',
  'repoWiki.error.invalidRetries': '重試次數必須是 0 到 3 之間的整數',
  'repoWiki.error.truncated': '頁面超出模型輸出上限而被截斷。請重試該頁面',
  'repoWiki.error.thoughtLevelUnsupported': '所選模型不支援該思考檔位。請換一個檔位或模型',
  'repoWiki.error.readStatus': '讀取儲存庫 Wiki 狀態失敗',
  'repoWiki.error.readPage': '讀取儲存庫 Wiki 頁面失敗',
  'repoWiki.error.startGeneration': '啟動儲存庫 Wiki 產生失敗',
  'repoWiki.error.stopGeneration': '停止儲存庫 Wiki 產生失敗',
  'repoWiki.error.retryPage': '重試儲存庫 Wiki 頁面失敗',
  'repoWiki.error.deleteWiki': '刪除儲存庫 Wiki 失敗',
};
