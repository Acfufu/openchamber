...
export const dict: Record<I18nKey, string> = {
  ...
  "mobile.wiki.pane.noDirectory": "Selecione um projeto para ler o wiki do repositório dele.",
  ...
  // Repo Wiki
  'contextRail.surface.repoWiki.description': 'Guia de arquitetura gerado por IA para este repositório',
  'contextRail.surface.repoWiki': 'Wiki do repositório',
  'contextPanel.mode.repoWiki': 'Wiki do repositório',
  'repoWiki.empty.title': 'Ainda não há wiki do repositório',
  'repoWiki.empty.description': 'Gere um guia de arquitetura deste repositório: um catálogo de páginas explicando como o código funciona, escrito lendo o código.',
  'repoWiki.empty.readOnlyDescription': 'O wiki do repositório é gerado na versão web ou desktop. Esta aba é somente de leitura.',
  'repoWiki.options.language': 'Idioma',
  'repoWiki.options.diagrams': 'Gerar diagramas',
  'repoWiki.options.diagrams.hint': 'Adiciona diagramas Mermaid onde eles realmente ajudam',
  'repoWiki.options.model': 'Modelo',
  'repoWiki.options.model.default': 'Modelo padrão',
  'repoWiki.options.retries': 'Tentativas por página',
  'repoWiki.options.retries.none': 'Sem tentativas',
  'repoWiki.options.retries.hint': 'Uma chamada de página com falha é repetida até este número de vezes. Uma tentativa pode levar até 3 minutos.',
  'repoWiki.options.thoughtLevel': 'Nível de raciocínio',
  'repoWiki.options.thoughtLevel.default': 'Padrão do modelo',
  'repoWiki.options.thoughtLevel.off': 'Desligado',
  'repoWiki.options.thoughtLevel.low': 'Baixo',
  'repoWiki.options.thoughtLevel.medium': 'Médio',
  'repoWiki.options.thoughtLevel.high': 'Alto',
  'repoWiki.options.thoughtLevel.hint': 'Pede ao modelo um raciocínio mais profundo durante a escrita. Um nível que o modelo escolhido não puder atender é recusado.',
  'repoWiki.generate.action': 'Gerar',
  'repoWiki.generate.running': 'Gerando…',
  'repoWiki.generate.stop': 'Parar',
  'repoWiki.progress.stage.digesting': 'Lendo o repositório',
  'repoWiki.progress.stage.catalog': 'Projetando o catálogo',
  'repoWiki.progress.stage.pages': 'Escrevendo as páginas',
  'repoWiki.page.status.pending': 'Aguardando',
  'repoWiki.page.status.writing': 'Escrevendo',
  'repoWiki.page.status.done': 'Concluído',
  'repoWiki.page.status.failed': 'Falhou',
  'repoWiki.page.retry': 'Tentar novamente',
  'repoWiki.pages.failedCount': '{count} com erro',
  'repoWiki.pages.retryFailed': 'Tentar novamente as páginas com falha',
  'repoWiki.meta.details': 'Detalhes do wiki',
  'repoWiki.meta.pages': 'Páginas',
  'repoWiki.meta.model': 'Modelo',
  'repoWiki.meta.thoughtLevel': 'Nível de raciocínio',
  'repoWiki.meta.stage': 'Etapa',
  'repoWiki.switcher.label': 'Alternar projeto do wiki',
  'repoWiki.switcher.error': 'Não foi possível carregar a lista de projetos',
  'repoWiki.switcher.empty': 'Nenhum outro wiki armazenado',
  'repoWiki.stale.banner': 'O código mudou desde que esta wiki foi gerada.',
  'repoWiki.stale.regenerate': 'Gerar novamente',
  'repoWiki.delete.action': 'Excluir wiki',
  'repoWiki.delete.confirmTitle': 'Excluir esta wiki do repositório?',
  'repoWiki.delete.confirmDescription': 'As páginas geradas são removidas do armazenamento do OpenChamber. Seu repositório não é alterado.',
  'repoWiki.delete.confirm': 'Excluir',
  'repoWiki.delete.cancel': 'Cancelar',
  'repoWiki.error.generic': 'A wiki do repositório está indisponível',
  'repoWiki.error.runInProgress': 'Uma geração de wiki do repositório já está em andamento para este projeto',
  'repoWiki.error.noModel': 'Não há modelo disponível para esta wiki. Escolha um modelo nas opções e tente novamente',
  'repoWiki.error.noProviderLogin': 'Nenhum login do provedor foi encontrado para este modelo. Faça login no provedor ou escolha outro modelo',
  'repoWiki.error.contextTooSmall': 'O resumo do repositório excede o limite de contexto deste modelo: são necessários cerca de {required} caracteres e há {available} disponíveis',
  'repoWiki.error.noWiki': 'Este projeto ainda não tem wiki do repositório',
  'repoWiki.error.unknownPage': 'Essa página da wiki não existe mais',
  'repoWiki.error.pageNotFailed': 'Só uma página com falha pode ser tentada de novo. Em vez disso, gere a wiki novamente',
  'repoWiki.error.malformedResponse': 'A resposta da wiki do repositório tinha um formato inválido',
  'repoWiki.error.interrupted': 'A geração foi interrompida por uma reinicialização do servidor. Tente a página novamente para concluí-la',
  'repoWiki.error.invalidRetries': 'As tentativas devem ser um número entre 0 e 3',
  'repoWiki.error.truncated': 'A página excedeu o limite de saída do modelo e foi cortada. Tente a página novamente',
  'repoWiki.error.thoughtLevelUnsupported': 'O modelo escolhido não suporta este nível de raciocínio. Escolha outro nível ou modelo',
  'repoWiki.error.readStatus': 'Não foi possível ler o status da wiki do repositório',
  'repoWiki.error.readPage': 'Não foi possível ler a página da wiki do repositório',
  'repoWiki.error.startGeneration': 'Não foi possível iniciar a geração da wiki do repositório',
  'repoWiki.error.stopGeneration': 'Não foi possível parar a geração da wiki do repositório',
  'repoWiki.error.retryPage': 'Não foi possível tentar a página da wiki do repositório novamente',
  'repoWiki.error.deleteWiki': 'Não foi possível excluir a wiki do repositório',
};
