...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.wiki.pane.noDirectory': 'Wybierz projekt, aby przeczytać jego wiki repozytorium.',
  ...
  // Repo Wiki
  'contextRail.surface.repoWiki.description': 'Przewodnik po architekturze tego repozytorium wygenerowany przez AI',
  'contextRail.surface.repoWiki': 'Wiki repozytorium',
  'contextPanel.mode.repoWiki': 'Wiki repozytorium',
  'repoWiki.empty.title': 'Nie ma jeszcze wiki repozytorium',
  'repoWiki.empty.description': 'Wygeneruj przewodnik po architekturze tego repozytorium: katalog stron wyjaśniających, jak działa kod, pisanych przez lekturę kodu.',
  'repoWiki.empty.readOnlyDescription': 'Wiki repozytorium jest generowana w wersji internetowej lub desktopowej. Ta karta służy tylko do czytania.',
  'repoWiki.options.language': 'Język',
  'repoWiki.options.diagrams': 'Generuj diagramy',
  'repoWiki.options.diagrams.hint': 'Dodaje diagramy Mermaid tam, gdzie naprawdę pomagają',
  'repoWiki.options.model': 'Model',
  'repoWiki.options.model.default': 'Model domyślny',
  'repoWiki.options.retries': 'Ponowienia na stronę',
  'repoWiki.options.retries.none': 'Bez ponowień',
  'repoWiki.options.retries.hint': 'Nieudane wywołanie strony jest ponawiane do tej liczby razy. Jedna próba może trwać do 3 minut.',
  'repoWiki.options.thoughtLevel': 'Poziom myślenia',
  'repoWiki.options.thoughtLevel.default': 'Domyślny modelu',
  'repoWiki.options.thoughtLevel.off': 'Wyłączony',
  'repoWiki.options.thoughtLevel.low': 'Niski',
  'repoWiki.options.thoughtLevel.medium': 'Średni',
  'repoWiki.options.thoughtLevel.high': 'Wysoki',
  'repoWiki.options.thoughtLevel.hint': 'Prosi model o głębsze rozumowanie podczas pisania. Poziom, którego wybrany model nie może zapewnić, zostanie odrzucony.',
  'repoWiki.generate.action': 'Generuj',
  'repoWiki.generate.running': 'Generowanie…',
  'repoWiki.generate.stop': 'Zatrzymaj',
  'repoWiki.progress.stage.digesting': 'Przetwarzanie repozytorium',
  'repoWiki.progress.stage.catalog': 'Projektowanie katalogu',
  'repoWiki.progress.stage.pages': 'Pisanie stron',
  'repoWiki.page.status.pending': 'Oczekiwanie',
  'repoWiki.page.status.writing': 'Pisanie',
  ...
  'repoWiki.pages.retryFailed': 'Ponów nieudane strony',
  'repoWiki.meta.details': 'Szczegóły wiki',
  'repoWiki.meta.pages': 'Strony',
  'repoWiki.meta.model': 'Model',
  'repoWiki.meta.thoughtLevel': 'Poziom myślenia',
  'repoWiki.meta.stage': 'Etap',
  'repoWiki.switcher.label': 'Przełącz projekt wiki',
  'repoWiki.switcher.error': 'Nie udało się wczytać listy projektów',
  'repoWiki.switcher.empty': 'Brak innych zapisanych wiki',
  ...
  'repoWiki.delete.confirmTitle': 'Usunąć tę wiki repozytorium?',
  'repoWiki.delete.confirmDescription': 'Wygenerowane strony zostaną usunięte z pamięci OpenChamber. Twoje repozytorium pozostanie nietknięte.',
  'repoWiki.delete.confirm': 'Usuń',
  'repoWiki.delete.cancel': 'Anuluj',
  'repoWiki.error.generic': 'Wiki repozytorium jest niedostępna',
  'repoWiki.error.runInProgress': 'Generowanie wiki repozytorium jest już w toku dla tego projektu',
  'repoWiki.error.noModel': 'Brak modelu dostępnego dla tej wiki. Wybierz model w opcjach i spróbuj ponownie',
  'repoWiki.error.noProviderLogin': 'Nie znaleziono logowania do dostawcy dla tego modelu. Zaloguj się u dostawcy lub wybierz inny model',
  'repoWiki.error.contextTooSmall': 'Podsumowanie repozytorium przekracza limit kontekstu tego modelu: potrzebne około {required} znaków, dostępne {available}',
  'repoWiki.error.noWiki': 'Ten projekt nie ma jeszcze wiki repozytorium',
  'repoWiki.error.unknownPage': 'Ta strona wiki już nie istnieje',
  'repoWiki.error.pageNotFailed': 'Tylko strona z błędem może zostać ponowiona. Zamiast tego wygeneruj wiki od nowa',
  'repoWiki.error.malformedResponse': 'Odpowiedź wiki repozytorium miała nieprawidłowy format',
  'repoWiki.error.interrupted': 'Generowanie zostało przerwane przez ponowne uruchomienie serwera. Ponów stronę, aby ją ukończyć',
  'repoWiki.error.invalidRetries': 'Liczba ponowień musi być liczbą od 0 do 3',
  'repoWiki.error.truncated': 'Strona przekroczyła limit wyjścia modelu i została ucięta. Ponów stronę',
  'repoWiki.error.thoughtLevelUnsupported': 'Wybrany model nie obsługuje tego poziomu myślenia. Wybierz inny poziom lub model',
  'repoWiki.error.readStatus': 'Nie udało się odczytać stanu wiki repozytorium',
  'repoWiki.error.readPage': 'Nie udało się odczytać strony wiki repozytorium',
  'repoWiki.error.startGeneration': 'Nie udało się rozpocząć generowania wiki repozytorium',
  'repoWiki.error.stopGeneration': 'Nie udało się zatrzymać generowania wiki repozytorium',
  'repoWiki.error.retryPage': 'Nie udało się ponowić strony wiki repozytorium',
  'repoWiki.error.deleteWiki': 'Nie udało się usunąć wiki repozytorium',
} as const;
