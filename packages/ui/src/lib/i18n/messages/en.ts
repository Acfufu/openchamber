...
export const dict = {
  ...
  'mobile.wiki.pane.noDirectory': 'Open a project to read its Repo Wiki.',
  ...
  'contextRail.surface.repoWiki.description': 'AI-generated architecture guide for this repository',
  ...
  'repoWiki.empty.title': 'No Repo Wiki yet',
  'repoWiki.empty.description': 'Generate an architecture guide for this repository: a catalog of pages explaining how the code works, written by reading the code.',
  'repoWiki.empty.readOnlyDescription': 'The Repo Wiki for this repository is generated from the web or desktop surface. This tab is for reading.',
  'repoWiki.options.language': 'Language',
  'repoWiki.options.diagrams': 'Generate diagrams',
  'repoWiki.options.diagrams.hint': 'Add Mermaid diagrams where they genuinely help',
  'repoWiki.options.model': 'Model',
  'repoWiki.options.model.default': 'Default model',
  'repoWiki.options.retries': 'Retries per page',
  'repoWiki.options.retries.none': 'No retries',
  'repoWiki.options.retries.hint': 'A failed page call retries up to this many times. One attempt can take up to 3 minutes.',
  'repoWiki.options.thoughtLevel': 'Thought level',
  'repoWiki.options.thoughtLevel.default': 'Model default',
  'repoWiki.options.thoughtLevel.off': 'Off',
  'repoWiki.options.thoughtLevel.low': 'Low',
  'repoWiki.options.thoughtLevel.medium': 'Medium',
  'repoWiki.options.thoughtLevel.high': 'High',
  'repoWiki.options.thoughtLevel.hint': 'Ask the model for deeper reasoning while it writes. A level the chosen model cannot honor refuses the run.',
  'repoWiki.generate.action': 'Generate',
  'repoWiki.generate.running': 'Generating…',
  'repoWiki.generate.stop': 'Stop',
  'repoWiki.progress.stage.digesting': 'Reading the repository',
  'repoWiki.progress.stage.catalog': 'Designing the catalog',
  'repoWiki.progress.stage.pages': 'Writing pages',
  'repoWiki.page.status.pending': 'Waiting',
  'repoWiki.page.status.writing': 'Writing',
  ...
  'repoWiki.pages.retryFailed': 'Retry failed pages',
  'repoWiki.meta.details': 'Wiki details',
  'repoWiki.meta.pages': 'Pages',
  'repoWiki.meta.model': 'Model',
  'repoWiki.meta.thoughtLevel': 'Thought level',
  'repoWiki.meta.stage': 'Stage',
  'repoWiki.switcher.label': 'Switch wiki project',
  'repoWiki.switcher.error': 'Could not load the project list',
  'repoWiki.switcher.empty': 'No other stored wikis',
  ...
  'repoWiki.delete.confirmTitle': 'Delete this Repo Wiki?',
  'repoWiki.delete.confirmDescription': 'The generated pages are removed from OpenChamber storage. Your repository is not touched.',
  'repoWiki.delete.confirm': 'Delete',
  'repoWiki.delete.cancel': 'Cancel',
  'repoWiki.error.generic': 'Repo Wiki is unavailable',
  'repoWiki.error.runInProgress': 'A Repo Wiki generation is already running for this project',
  'repoWiki.error.noModel': 'No model is available for this wiki. Pick a model in the options and try again',
  'repoWiki.error.noProviderLogin': 'No provider login was found for this model. Sign in to the provider or pick a different model',
  'repoWiki.error.contextTooSmall': 'The repository digest is too large for this model: needs about {required} characters, {available} are available',
  'repoWiki.error.noWiki': 'No Repo Wiki exists for this project yet',
  'repoWiki.error.unknownPage': 'That wiki page no longer exists',
  'repoWiki.error.pageNotFailed': 'Only a failed page can be retried. Regenerate the wiki instead',
  'repoWiki.error.malformedResponse': 'The Repo Wiki response was malformed',
  'repoWiki.error.interrupted': 'Generation was interrupted by a server restart. Retry the page to finish it',
  'repoWiki.error.invalidRetries': 'Retries must be a number between 0 and 3',
  'repoWiki.error.truncated': 'The page exceeded the model output limit and was cut off. Retry the page',
  'repoWiki.error.thoughtLevelUnsupported': 'The chosen model does not support this thought level. Pick another level or model',
  'repoWiki.error.readStatus': 'Failed to read the Repo Wiki status',
  'repoWiki.error.readPage': 'Failed to read the Repo Wiki page',
  'repoWiki.error.startGeneration': 'Failed to start Repo Wiki generation',
  'repoWiki.error.stopGeneration': 'Failed to stop Repo Wiki generation',
  'repoWiki.error.retryPage': 'Failed to retry the Repo Wiki page',
  'repoWiki.error.deleteWiki': 'Failed to delete the Repo Wiki',
